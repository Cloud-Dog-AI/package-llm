...
This package provides: a unified LLM client abstraction supporting OpenAI, Ollama, and other providers with streaming, tool calling, and cost tracking.
...
# Run with coverage
pytest tests/ --cov=cloud_dog_llm --cov-report=term-missing
```
